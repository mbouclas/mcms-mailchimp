...
var Config = {
    ...
    publicDirJs : path.join(InstallationDir,'public/vendor/mcms/mailchimp/js'),
    publicDirCss : path.join(InstallationDir,'public/vendor/mcms/mailchimp/css'),
    publicDirImg : path.join(InstallationDir,'public/vendor/mcms/mailchimp/img'),
    publicDirTemplates : path.join(InstallationDir,'public/vendor/mcms/mailchimp/app/templates')
};
